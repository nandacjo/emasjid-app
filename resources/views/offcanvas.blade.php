...
<head>
    ...
    <meta name="description" content="E-masjid">
    <meta name="author" content="Aplikasi admnistrasi keuangan masjid">
    <meta name="generator" content="Hugo 0.112.5">
    <title>{{ config('app.name', 'E-Masjid') }}</title>

    <link rel="canonical" href="asset('offcanvas/offcanvas-navbar.css')">
...
<body class="bg-body-tertiary">
    ...
    <nav class="navbar navbar-expand-lg fixed-top navbar-dark bg-dark" aria-label="Main navigation">
        <div class="container">
            <a class="navbar-brand" href="{{ route('welcome') }}">E-Masjid App</a>
            ...
            <div class="navbar-collapse offcanvas-collapse" id="navbarsExampleDefault">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('login') }}">Login Sebagai Pengurus</a>
                    </li>
    ...
    <main class="container">
        <div class="d-flex align-items-center p-3 my-5 text-white bg-purple rounded shadow-sm">
            <img class="me-3" src="../assets/brand/bootstrap-logo-white.svg" alt="" width="48"
                height="38">
            <div class="lh-1">
                <h1 class="h6 mb-0 text-white lh-1 fw-bold">Aplikasi E-Masjid</h1>
                <small>Aplikasi Administrasi Keuangan Masjid</small>
            </div>
        </div>
            ...
            @foreach ($masjid as $item)
                <div class="d-flex text-body-secondary pt-3">
                    ...
                    <p class="pb-3 mb-0 small lh-sm border-bottom w-100">
                        <strong class="d-block text-gray-dark">{{ Str::ucfirst($item->nama) }}</strong>
                        {{ ucfirst($item->alamat) }}
                    </p>
                </div>
            @endforeach
