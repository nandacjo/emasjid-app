  ...
  <div class="wrapper">
    ...
    <div class="main">
      <nav class="navbar navbar-expand navbar-light navbar-bg">
        ...
        {{-- <h2 class="h1 fw-bold">{{ auth()->user()->masjid?->nama }}
        < /h2> --}}
            ...
            <ul class="navbar-nav navbar-align">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                  <a class="dropdown-item" href="{{ route('user-profil.edit', 0) }}"><i class="align-middle me-1" data-feather="user"></i> Ubah Profil</a>
